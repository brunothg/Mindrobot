...
public class MindTalkTest {
	...
	public void testRunSimpleCommands() throws Exception {
		...
		RobotControlTest ctrl = new RobotControlTest(true, true, false, true,
				false, false);
	...
	public void testSplitWennDannSonstBlock() throws Exception {
		...
		String starter = "Dann";
		String[] block = new String[] { "Wenn", "steheVorHindernis?", "Dann",
				"Wenn", "binVerwirrt?", "Dann", "vorwärts.", "Sonst", "Ende",
				"Sonst", "Wenn", "!steheVorHindernis?", "Dann", "linksDrehen.",
				"Sonst", "rechtsDrehen.", "Ende", "Ende" };

		String[] expectedFirstBlock = new String[] { "Wenn",
				"steheVorHindernis?", "Dann", "Wenn", "binVerwirrt?", "Dann",
				"vorwärts.", "Sonst", "Ende" };
		String[] expectedSecondBlock = new String[] { "Sonst", "Wenn",
				"!steheVorHindernis?", "Dann", "linksDrehen.", "Sonst",
	...
	public void testSubBlock() throws Exception {
		...
		String[] block = new String[] { "Wiederhole", "2", "vorwärts.",
				"rückwärts.", "linksDrehen.", "rechtsDrehen.", "Wenn",
				"steheVorHindernis?", "Dann", "linksDrehen.", "Ende", "Ende" };
		String[] expectedSubBlock = new String[] { "rückwärts.",
				"linksDrehen.", "rechtsDrehen.", "Wenn", "steheVorHindernis?" };
	...
	class RobotControlTest implements RobotControl {
		...
		public RobotControlTest(boolean moveforwards, boolean movebackwards,
				boolean isblockedfieldinfront,
				boolean isfieldinfrontaccessible,
				boolean standonconfusingfield, boolean isconfused) {
