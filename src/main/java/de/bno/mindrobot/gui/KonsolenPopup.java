...
public class KonsolenPopup extends JPopupMenu implements ActionListener
{
	...
	private void createAufZielfledFrage()
	{
	...
	{
		wennDann = new JMenuItem(String.format("%s ...? %s ...", String(SYNTAX_WENN), String(SYNTAX_DANN)));
	...
	public void actionPerformed(ActionEvent arg0)
	{
		...
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.WENN_DANN_SONST);
		}
		...
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.SOLANGE_WIE);
		}
		else if (arg0.getSource() == repeatX)
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.WIEDERHOLE_X);
		}
		else if (arg0.getSource() == moveBack)
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.RUECKWAERTS);
		}
		...
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.HINDERNIS_Q);
		}
		...
		{
			Signals.sendSignal(Signals.SIGNAL_KONSOLE_INSERT, Insert.SETZE_GESCHWINDIGKEIT);
		}
